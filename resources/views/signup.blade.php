...
<body class="bg-amber-600 flex items-center justify-center">
    ...
    <form class="bg-white rounded-xl h-fit w-2/4 p-5 flex flex-col space-y-11 justify-center items-center shadow-md hover:shadow-xl transition-shadow">
        ...
        <div class="flex flex-col items-center">
            ...
            <input type="text" name="nama" id="nama" placeholder="nama anda" class="outline-none bg-gray-300 rounded-md p-5 focus:bg-gray-500 drop-shadow focus:drop-shadow-lg focus:scale-110 transition-all">
        </div>
        <!-- email/item 1 -->
        <div class="flex flex-col items-center">
        ...
        <div class="flex flex-col items-center">
            ...
            <input type="password" name="pass" id="pass" placeholder="password yang kuat" class="outline-none bg-gray-300 rounded-md p-5 focus:bg-gray-500 drop-shadow focus:drop-shadow-lg focus:scale-110 transition-all">
        </div>
        <!-- konfirmasi password/item 3 -->
        <div class="flex flex-col items-center">
            <label for="nama">Konfirmasi Password</label>
            <input type="password" name="pass" id="pass" placeholder="masukan password lagi" class="outline-none bg-gray-300 rounded-md p-5 focus:bg-gray-500 drop-shadow focus:drop-shadow-lg focus:scale-110 transition-all">
        </div>
        <!-- submit/item 4 -->
